...
WebServer = hs.httpserver.hsminweb.new(os.getenv("HOME") .. "/dotfiles/hammerspoon/wmui/dist")
WebServer:queryLogging(true)
hs.printf("Query log at %s", WebServer._accessLog)
WebServer:start()
...
ModalCommander = modal_commander.new({
    ...
    appAddress = "http://localhost:" .. WebServer:port(),
